...
def read_data(reader: DatasetReader) -> Tuple[List[Instance], List[Instance]]:
    print("Reading data")
    training_data = list(reader.read("E:/root/Projects/learn_nlp/quick_start/data/movie_review/train.tsv"))
    validation_data = list(reader.read("E:/root/Projects/learn_nlp/quick_start/data/movie_review/dev.tsv"))
