...
token_indexers: Dict[str, TokenIndexer] = {"tokens": SingleIdTokenIndexer(namespace='tokens')}
text_field = TextField(tokens, token_indexers=token_indexers)

label_field = LabelField("pos",label_namespace='labels')
